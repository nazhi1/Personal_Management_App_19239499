...
public class TodoHelper extends SQLiteOpenHelper {
    ...
    TodoHelper(@Nullable Context context) {
    ...
    void addBook(String name, String loc, String status){
    ...
    void updateData(String row_id, String name, String location, String status){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_NAME, name);
